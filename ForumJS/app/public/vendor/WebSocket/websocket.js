...
function _connect(url)
{
    ...
    socket.on('message', msg => {
        ...
        if (topic !== undefined) {
            // Search for random
            if (topic == "/api/users/event/newPoint") {
                //-- reception d'un nouveua point du traceur GPS
                console.log("new point of GPS");
